...
pub trait InstructionScheduler: Send + Sync {
    ...
    ) -> Result<crate::jit::compiler::CompiledIRBlock, VmError>;
...
impl OptimizedInstructionScheduler {
    ...
    /// 获取操作类型
    fn get_operation_type(&self, instruction: &crate::jit::compiler::CompiledIROp) -> String {
    ...
    /// 估计指令执行时间
    fn estimate_instruction_time(&self, instruction: &crate::jit::compiler::CompiledIROp) -> u32 {
        match &instruction.op {
    ...
    fn has_dependency(
        &self,
        inst1: &crate::jit::compiler::CompiledIROp,
        inst2: &crate::jit::compiler::CompiledIROp,
    ) -> bool {
    ...
    /// 获取指令使用的寄存器
    fn get_registers(&self, instruction: &crate::jit::compiler::CompiledIROp) -> Vec<String> {
    ...
    /// 检查指令是否有内存访问
    fn has_memory_access(&self, instruction: &crate::jit::compiler::CompiledIROp) -> bool {
