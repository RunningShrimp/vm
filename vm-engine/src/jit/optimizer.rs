...
pub struct DefaultIROptimizer {
    ...
    /// JIT配置
    config: crate::jit::core::JITConfig,
    /// 启用的优化
...
mod tests {
    ...
    fn test_default_optimizer_creation() {
        let optimizer = DefaultIROptimizer::new(crate::jit::core::JITConfig::default());
    ...
    fn test_default_optimizer_optimize() {
        ...
        let mut optimizer = DefaultIROptimizer::new(crate::jit::core::JITConfig::default());
        let block = IRBlock {
