...
impl JITErrorBuilder {
    ...
    pub fn config(message: impl Into<String>) -> VmError {
        VmError::Configuration {
            source: ConfigError::InvalidValue("config".to_string(), message.into()),
    ...
    pub fn memory(message: impl Into<String>) -> VmError {
        VmError::Memory {
            source: MemoryError::AllocationFailed(message.into()),
    ...
    pub fn hardware_acceleration(message: impl Into<String>) -> VmError {
        VmError::Device {
            source: DeviceError::InitializationFailed(message.into()),
    ...
    pub fn performance_analysis(message: impl Into<String>) -> VmError {
        VmError::Core {
            source: CoreError::UnsupportedOperation(message.into()),
    ...
    pub fn resource_exhausted(resource: impl Into<String>) -> VmError {
        VmError::Core {
            source: CoreError::ResourceNotAvailable(resource.into()),
    ...
    pub fn timeout(operation: impl Into<String>) -> VmError {
        VmError::Core {
            source: CoreError::Timeout(operation.into()),
    ...
    pub fn concurrency(message: impl Into<String>) -> VmError {
        VmError::Core {
            source: CoreError::ResourceInUse(message.into()),
