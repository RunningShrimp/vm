...
use crate::jit::performance_monitoring_feedback::PerformanceMonitoringFeedbackManager;
...
impl JITEngineIntegrationTest {
    ...
    fn test_performance_monitoring_feedback(&self, ir_block: &IRBlock) -> Result<(), VmError> {
        ...
        // 发送性能监控事件
        use crate::jit::performance_monitoring_feedback::PerformanceMonitoringEvent;
