...
impl JITEngine {
    ...
    pub fn new(config: JITConfig) -> Self {
        // 使用分层缓存
        let tiered_cache_config = crate::jit::tiered_cache::TieredCacheConfig::default();
    ...
    fn compilation_worker(
        ...
        let mut instruction_scheduler = crate::jit::instruction_scheduler::ListScheduler::new();
        let mut code_generator = crate::jit::codegen::DefaultCodeGenerator::new();
