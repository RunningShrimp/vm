...
pub fn load_kernel_file(path: &str, load_addr: GuestAddr) -> VmResult<()> {
    use std::fs;
...
pub fn load_test_program(
    ...
    code_base: GuestAddr,
        ...
        // 简单的测试程序：RISC-V 指令序列
        // addi x1, x0, 42  (0x02900513)
        // addi x2, x0, 10  (0x00A00613)
        // add x3, x1, x2   (0x00C581B3)
        // ret              (0x00008067)
        let test_code = vec![
            0x13, 0x05, 0x90, 0x02, // addi x1, x0, 42
            0x13, 0x06, 0xA0, 0x00, // addi x2, x0, 10
            0xB3, 0x81, 0xC5, 0x00, // add x3, x1, x2
            0x67, 0x80, 0x00, 0x00, // ret
        ];

    load_kernel(mmu, &test_code, code_base)
}
