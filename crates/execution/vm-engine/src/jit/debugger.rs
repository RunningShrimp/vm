...
impl<T: RegisterAllocator> RegisterAllocator for DebuggerDecorator<T> {
    ...
    ) -> Result<crate::jit::compiler::CompiledIRBlock, vm_core::VmError> {
        let pc = block.start_pc;
    ...
    fn get_stats(&self) -> crate::jit::register_allocator::RegisterAllocationStats {
...
impl<T: InstructionScheduler> InstructionScheduler for DebuggerDecorator<T> {
    ...
    fn get_stats(&self) -> crate::jit::instruction_scheduler::InstructionSchedulingStats {
        self.inner.get_stats()
    }
}
...
impl<T: CodeCache> CodeCache for DebugCodeCache<T> {
    ...
    fn stats(&self) -> crate::jit::code_cache::CacheStats {
        self.inner.stats()
    }
