...
mod tests {
    ...
    fn test_profile_collector_block_recording() {
        ...
        let profile1 = collector
            .get_block_profile(1)
            .expect("Block profile 1 should exist");
    ...
    fn test_profile_collector_branch_recording() {
        ...
        let profile = collector
            .get_block_profile(1)
            .expect("Block profile 1 should exist after recording");
    ...
    fn test_profile_collector_cache_recording() {
        ...
        let profile = collector
            .get_block_profile(1)
            .expect("Block profile 1 should exist after cache recording");
    ...
    fn test_aot_optimization_driver() {
        ...
        let hint = driver
            .get_optimization_hint(1)
            .expect("Optimization hint for block 1 should exist");
