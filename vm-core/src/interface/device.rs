...
use super::{Configurable, DeviceId, DeviceStatus, DeviceType, Observable, VmComponent, VmError};
...
impl VmComponent for VirtualDevice {
    ...
    fn status(&self) -> super::ComponentStatus {
        match self.state.status {
            DeviceStatus::Uninitialized => super::ComponentStatus::Uninitialized,
            DeviceStatus::Initialized => super::ComponentStatus::Initialized,
            DeviceStatus::Running => super::ComponentStatus::Running,
            DeviceStatus::Stopped => super::ComponentStatus::Stopped,
            DeviceStatus::Error(_) => super::ComponentStatus::Error,
        }
    }
...
impl Device for VirtualDevice {
    ...
    fn handle_read(&mut self, offset: u64, _size: usize) -> Result<u64, VmError> {
        ...
        if offset >= self.config.size {
            return Err(VmError::Device(crate::DeviceError::IoFailed {
