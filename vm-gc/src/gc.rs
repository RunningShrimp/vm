...
/// Optimized GC statistics (extended from base GcStats)
#[derive(Debug, Clone, Default)]
pub struct OptimizedGcStats {
...
pub struct OptimizedGc {
    ...
    /// Statistics
    stats: Arc<RwLock<OptimizedGcStats>>,
    /// Barrier type
...
impl OptimizedGc {
    ...
    pub fn new(num_workers: usize, target_pause_us: u64, barrier_type: WriteBarrierType) -> Self {
        Self {
            ...
            stats: Arc::new(RwLock::new(OptimizedGcStats::default())),
    ...
    /// Get statistics
    pub fn get_stats(&self) -> OptimizedGcStats {
