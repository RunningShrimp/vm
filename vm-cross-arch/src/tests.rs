...
fn test_float_conversion_translation() {
    ...
    builder.push(IROp::Fcvtws { dst: 0, src: 1 });
    builder.push(IROp::Fcvtsw { dst: 2, src: 3 });
    builder.push(IROp::Fcvtsd { dst: 4, src: 5 });
    builder.set_term(Terminator::Ret);
    let block = builder.build();
...
fn test_float_abs_neg_translation() {
    ...
    builder.push(IROp::Fabs { dst: 0, src: 1 });
    builder.push(IROp::FnegS { dst: 2, src: 3 });
    builder.set_term(Terminator::Ret);
    let block = builder.build();
...
fn test_float_class_translation() {
    ...
    builder.push(IROp::Fclass { dst: 0, src: 1 });
    builder.push(IROp::FclassS { dst: 2, src: 3 });
    builder.set_term(Terminator::Ret);
    let block = builder.build();
...
fn test_float_mv_translation() {
    ...
    builder.push(IROp::FmvXW { dst: 0, src: 1 });
    builder.push(IROp::FmvDX { dst: 2, src: 3 });
    builder.set_term(Terminator::Ret);
    let block = builder.build();
...
fn test_more_float_conversions() {
    ...
    builder.push(IROp::Fcvtwus { dst: 0, src: 1 });
    builder.push(IROp::Fcvtdwu { dst: 2, src: 3 });
    builder.push(IROp::Fcvtlud { dst: 4, src: 5 });
    builder.set_term(Terminator::Ret);
    let block = builder.build();
