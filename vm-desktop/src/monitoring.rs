...
impl MonitoringService {
    ...
    fn collect_enhanced_metrics(vm_id: &str, base: VmMetrics) -> EnhancedVmMetrics {
        ...
        EnhancedVmMetrics {
            base,
            jit_compilation_rate: rng.random_range(0.0..1000.0), // 0-1000 compilations/sec
            tlb_hit_rate: rng.random_range(70.0..99.9),          // 70-99.9%
            cache_hit_rate: rng.random_range(80.0..99.9),        // 80-99.9%
            instruction_count: rng.random_range(0..1_000_000_000), // 0-1B instructions
            syscalls_per_sec: rng.random_range(0.0..10000.0),    // 0-10K syscalls/sec
            page_faults_per_sec: rng.random_range(0.0..100.0),   // 0-100 page faults/sec
            context_switches_per_sec: rng.random_range(0.0..1000.0), // 0-1K context switches/sec
        }
    }
}
