...
use crate::protocol::{VmCapabilities, VmId};
...
pub struct VmDiscovery {
    config: Arc<crate::architecture::DistributedArchitectureConfig>,
...
impl VmDiscovery {
    ...
    pub fn new(
        config: &crate::architecture::DistributedArchitectureConfig,
