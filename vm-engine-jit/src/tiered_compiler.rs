...
use crate::compiler::{CompilationStats, CompiledIRBlock, JITCompiler};
...
impl TieredJITCompiler {
    ...
    fn lock_tiered_cache(
        &self,
    ) -> Result<std::sync::MutexGuard<'_, crate::tiered_cache::TieredCodeCache>, VmError> {
...
impl BaselineJITCompiler {
    fn generate_code(&self, ops: &[crate::compiler::CompiledIROp]) -> Vec<u8> {
