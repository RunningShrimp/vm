...
use crate::adaptive_threshold::{PerformanceMetrics, AdaptiveCompilationConfig};
...
pub struct AdaptiveOptimizationStrategyManager {
    ...
    /// 基础优化器
    base_optimizer: crate::optimizer::DefaultIROptimizer,
    /// SIMD优化器
...
impl AdaptiveOptimizationStrategyManager {
    ...
    pub fn new(
        ...
        Self {
            ...
            base_optimizer: crate::optimizer::DefaultIROptimizer::new(crate::core::JITConfig::default()),
