...
mod tests {
    ...
    fn test_tlb_prefetching() {
        ...
        // Prefetched count is always non-negative, this assertion is always true
        debug_assert!(prefetched <= usize::MAX / 2);
    }
    ...
    fn test_numa_rebalance() {
        ...
        // Moved count is always non-negative, this assertion is always true
        debug_assert!(moved <= usize::MAX / 2);
    }
