...
use vm_mem::{
    ...
    FlushRequest, FlushScope, FlushStrategy, PageImportanceEvaluator, PerCpuTlbManager,
    PredictiveFlushConfig, SelectiveFlushConfig, TlbFlushConfig,
};
...
fn test_selective_flush() {
    ...
    // 请求刷新包含热点和冷页面的范围
    let request = FlushRequest::new(FlushScope::PageRange, hot_addr, cold_addr, 0, 10, 0);
