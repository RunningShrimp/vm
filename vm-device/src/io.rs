...
pub trait ZeroCopyIo: Send {
    /// 提交 I/O 请求
    fn submit(&mut self, req: IoRequest) -> Result<(), String>;
...
pub mod uring {
    ...
    impl IoUringBackend {
        /// 创建新的 io_uring 后端
        pub fn new(fd: i32, depth: u32) -> Result<Self, String> {
            Ok(Self {
                depth,
...
impl IoScheduler {
    ...
    /// 提交 I/O 请求
    pub fn submit(&mut self, req: IoRequest) -> Result<(), String> {
