...
pub trait InstructionEncoding {
    ...
    fn encode_immediate(&self, imm: i64, format: ImmediateFormat) -> Result<Self::Word, EncodingError>;

    /// Encode a memory operand
    fn encode_memory_operand(&self, base: RegId, offset: i64, size: u8) -> Result<MemoryOperand, EncodingError>;
...
mod tests {
    ...
    #[test]
    fn test_sign_extend() {
        assert_eq!(utils::sign_extend(0b101, 3), 0b11111101);
